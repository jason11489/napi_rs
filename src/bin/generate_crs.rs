...
#[allow(unused)]
fn generate_crs_files(
  file_path: &str,
  tree_height: u64,
  num_of_attributes: Option<usize>,
  ...
  use zkrypto_circuits::cc_groth16::{
  ...
  if cfg!(feature = "zkvoting-binary") {
    ...
    to_file::<ProvingKey<Bn254>>(
      &pk,
      &format!(
        "{}/zkvoting/binary/crs_height_{}.pk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<VerifyingKey<Bn254>>(
      &vk,
      &format!(
        "{}/zkvoting/binary/crs_height_{}.vk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<PreparedVerifyingKey<Bn254>>(
      &pvk,
      &format!(
        "{}/zkvoting/binary/crs_height_{}.pvk",
        file_path, tree_height
      ),
    )
    .unwrap();
  ...
  if cfg!(feature = "zkvoting-binary-weight") {
    ...
    to_file::<ProvingKey<Bn254>>(
      &pk,
      &format!(
        "{}/zkvoting/weight/crs_height_{}.pk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<VerifyingKey<Bn254>>(
      &vk,
      &format!(
        "{}/zkvoting/weight/crs_height_{}.vk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<PreparedVerifyingKey<Bn254>>(
      &pvk,
      &format!(
        "{}/zkvoting/weight/crs_height_{}.pvk",
        file_path, tree_height
      ),
    )
    .unwrap();
  ...
  if cfg!(feature = "zkvoting-preference") {
    ...
    to_file::<ProvingKey<Bn254>>(
      &pk,
      &format!(
        "{}/zkvoting/preference/crs_height_{}.pk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<VerifyingKey<Bn254>>(
      &vk,
      &format!(
        "{}/zkvoting/preference/crs_height_{}.vk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<PreparedVerifyingKey<Bn254>>(
      &pvk,
      &format!(
        "{}/zkvoting/preference/crs_height_{}.pvk",
        file_path, tree_height
      ),
    )
    .unwrap();
  ...
  if cfg!(feature = "zkvoting-score") {
    ...
    to_file::<ProvingKey<Bn254>>(
      &pk,
      &format!("{}/zkvoting/score/crs_height_{}.pk", file_path, tree_height),
    )
    .unwrap();
    to_file::<VerifyingKey<Bn254>>(
      &vk,
      &format!("{}/zkvoting/score/crs_height_{}.vk", file_path, tree_height),
    )
    .unwrap();
    to_file::<PreparedVerifyingKey<Bn254>>(
      &pvk,
      &format!(
        "{}/zkvoting/score/crs_height_{}.pvk",
        file_path, tree_height
      ),
    )
    .unwrap();
  ...
  if cfg!(feature = "zkvoting-pollstation") {
    ...
    to_file::<ark_groth16::ProvingKey<Bn254>>(
      &pk,
      &format!(
        "{}/zkvoting/pollstation/crs_height_{}.pk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<ark_groth16::VerifyingKey<Bn254>>(
      &vk,
      &format!(
        "{}/zkvoting/pollstation/crs_height_{}.vk",
        file_path, tree_height
      ),
    )
    .unwrap();
    to_file::<ark_groth16::PreparedVerifyingKey<Bn254>>(
      &pvk,
      &format!(
        "{}/zkvoting/pollstation/crs_height_{}.pvk",
        file_path, tree_height
      ),
    )
    .unwrap();
  ...
  if cfg!(feature = "zkwallet") {
    ...
    to_file::<ProvingKey<Bn254>>(
      &pk,
      &format!("{}/zkwallet/crs_height_{}.pk", file_path, tree_height),
    )
    .unwrap();
    to_file::<VerifyingKey<Bn254>>(
      &vk,
      &format!("{}/zkwallet/crs_height_{}.vk", file_path, tree_height),
    )
    .unwrap();
    to_file::<PreparedVerifyingKey<Bn254>>(
      &pvk,
      &format!("{}/zkwallet/crs_height_{}.pvk", file_path, tree_height),
    )
    .unwrap();
  ...
  if cfg!(feature = "zkdid") {
    ...
    match num_of_attributes {
      Some(val) => {
        ...
        to_file::<ProvingKey<Bn254>>(
          &pk,
          &format!("{}/zkdid/crs_height_{}_{}.pk", file_path, tree_height, val),
        )
        .unwrap();
        to_file::<VerifyingKey<Bn254>>(
          &vk,
          &format!("{}/zkdid/crs_height_{}_{}.vk", file_path, tree_height, val),
        )
        .unwrap();
        to_file::<PreparedVerifyingKey<Bn254>>(
          &pvk,
          &format!("{}/zkdid/crs_height_{}_{}.pvk", file_path, tree_height, val),
        )
        .unwrap();
      }
      None => {
  ...
  if cfg!(feature = "zksbt") {
    ...
    match num_of_attributes {
      Some(val) => {
        let circuit =
          <ZkSbtCircuit<F> as MockingCircuit<F>>::generate_circuit(rc.clone(), val, &mut rng)
            .unwrap();
        ...
        to_file::<VerifyingKey<Bn254>>(&vk, &format!("{}/zksbt/crs_{}.vk", file_path, val))
          .unwrap();
        to_file::<PreparedVerifyingKey<Bn254>>(
          &pvk,
          &format!("{}/zksbt/crs_{}.pvk", file_path, val),
        )
        .unwrap();
      }
      None => {
